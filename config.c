...
char* states[] = { STATE_IDLE_NAME, STATE_RUNNING_NAME, STATE_WAITFORCONFIRM_NAME, STATE_SHUTTINGDOWN_NAME, STATE_INTERACTIVE_NAME };
int state_id[] = { STATE_SLEEP, STATE_MOVE, STATE_WAITFORCONFIRM, STATE_SHUTTINGDOWN, STATE_INTERACTIVE};

char* actions[] = { ACTION_START_RUNNING_NAME, ACTION_REVERSE_NAME, ACTION_CANCEL_SHUTDOWN_NAME, ACTION_REQUEST_SHUTDOWN_NAME, ACTION_CONFIRM_SHUTDOWN_NAME, ACTION_GET_NAME, ACTION_START_INTERACTIVE_NAME };
int action_id[] = { ACTION_START_RUNNING, ACTION_REVERSE, ACTION_CANCEL_SHUTDOWN, ACTION_REQUEST_SHUTDOWN, ACTION_CONFIRM_SHUTDOWN, ACTION_GET, ACTION_START_INTERACTIVE};
